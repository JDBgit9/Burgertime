...
VALUES ("hamburger",false), ("cheeseburger",false), ("veggieburger",false),('Cheese Burger', FALSE);
VALUES ('Hamburger', FALSE), ('Pizza Burger', FALSE), ('Veggie Burger', FALSE),('Black Bean Burger', FALSE);
VALUES ('Impossible Burger', FALSE), ('Guacamole Burger', FALSE), ('Double Stack Burger', FALSE), ('Charbroiled Burger', FALSE);
